...
🍃 ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ3.6.5 [ ʙᴇᴛᴀ ] </b>"""
    ...
    DONATE_TXT = """<b><i> ഞാൻ നിങ്ങളുടെ കയ്യിൽനിന്നും sᴜᴘᴘᴏʀᴛ മാത്രമേ പ്രതീക്ഷിക്കുന്നുള്ളൂ. @cinemaflixchannel എന്ന ചാനലിലുള്ള മൂവീ ഗ്രൂപ്പിൽ ᴊᴏɪɴ ചെയ്യ്ത് sᴜᴘᴘᴏʀᴛ ചെയ്യൂ.😊</i></b> """
